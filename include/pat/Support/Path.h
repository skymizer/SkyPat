...
//
//===----------------------------------------------------------------------===//
// This file declares the pat::Path. It follows TR2/boost
// filesystem (v3), but modified to remove exception handling and RTTI.
//===----------------------------------------------------------------------===//
#ifndef PAT_SUPPORT_PATH_H
#define PAT_SUPPORT_PATH_H
#include <stdint.h>
#include <iosfwd>
#include <string>
...
template<>
struct less<pat::Path> : public binary_function<pat::Path,
                                                     pat::Path,
                                                     bool>
{
  bool operator() (const pat::Path& pX,const pat::Path& pY) const {
