...
// EXPECT macro compares the actual value to an expected value by using the
...
SKYPAT_F(MyCase, fibonacci_test)
{
  ...
  // EXPECT are macros that resemble function calls. You test a class or function
