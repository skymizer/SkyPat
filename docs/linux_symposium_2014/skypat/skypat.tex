...
Because \textit{perf} gets runtime information by kernel directly rather than collecting by daemon, \textit{perf} eliminates lots of overhead to bookkeeping profiling information.
