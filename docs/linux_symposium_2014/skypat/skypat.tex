...
% compiler optimizations don't guarantee performance improvement, and the worst is: sometimes an optimization not only degrades performance but also introduce defeats in a program.
